    ...
    <div className="max-w-7xl mx-auto px-4">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <nav aria-label="breadcrumb" className="mb-12 mt-6">
          <div className="flex flex-wrap items-center gap-2 text-sm text-gray-900 dark:text-gray-100">
            <Link
              href="/"
            ...
            <span className="text-gray-400 dark:text-gray-500">/</span>
            <span className="text-gray-600 dark:text-gray-300 font-semibold truncate max-w-full sm:max-w-[40ch]">
              {blog.title}
            </span>
          </div>
        </nav>
        ...
        <article
          id="article-content"
          className="pb-16 px-0 bg-white dark:bg-[#171717] rounded-xl max-w-7xl mx-auto"
        >
          <h1 className="text-3xl font-bold text-primary dark:text-primary-light mb-4">
            {blog.title}
          </h1>
          <div className="mb-2 text-gray-500 dark:text-gray-300 text-sm">
            بواسطة {blog.author}
          </div>
          ...
          <div className="prose prose-lg max-w-7xl text-gray-800 dark:text-gray-200">
        ...
        <section className="mt-10 mb-20">
          <div className="max-w-7xl mx-auto bg-gray-50 dark:bg-[#232323] rounded-2xl shadow-md p-6 md:p-8">
