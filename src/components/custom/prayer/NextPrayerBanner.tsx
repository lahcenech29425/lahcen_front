...
export default function NextPrayerBanner({
  ...
  if (isLoading || !nextPrayer) {
    return (
      <div className="mt-6 sm:mt-8 mb-6 sm:mb-8" dir="rtl">
        <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-white border-2 border-gray-200 shadow-xl">
          <div className="px-4 py-5 sm:px-6 sm:py-6 md:px-10 md:py-8 bg-gradient-to-br from-white via-gray-50/30 to-white">
            {/* Header skeleton */}
            <div className="mb-3 sm:mb-4 flex items-center gap-1.5 sm:gap-2">
              <div className="h-4 w-4 sm:h-5 sm:w-5 bg-gray-200 rounded animate-pulse" />
          ...
          <div className="h-1 sm:h-1.5 w-full bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 animate-pulse" />
        </div>
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-white border-2 border-gray-200 shadow-xl hover:shadow-2xl transition-all duration-300">
        {/* Contenu principal */}
        <div className="px-4 py-5 sm:px-6 sm:py-6 md:px-10 md:py-8 bg-gradient-to-br from-white via-gray-50/30 to-white">
          <div className="mb-3 sm:mb-4 flex items-center gap-1.5 sm:gap-2">
            <Clock
