...
export default function Footer({ data }: { data: FooterType }) {
  ...
  return (
    <footer
      className="bg-gray-100 dark:bg-[#232323] text-gray-900 dark:text-gray-100 pt-12 pb-6"
      dir="rtl"
    >
      <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-x-6 gap-y-8 text-right">
              {footer.menu.map((menu) => (
                <div key={menu.id} className="min-w-[120px]">
                  <h4 className="font-semibold mb-3 text-base text-gray-900 dark:text-gray-100">
                    {menu.title}
                  </h4>
                    ...
                    {menu.links.map((link) => (
                      <li key={link.id}>
                        <Link
                          ...
                          className="hover:text-gray-700 dark:hover:text-white transition text-sm text-gray-600 dark:text-gray-300"
                        >
                          {link.title}
                        </Link>
                      </li>
        ...
        <div className="border-t border-gray-300 dark:border-gray-700 pt-6 text-center text-xs text-gray-600 dark:text-gray-200">
