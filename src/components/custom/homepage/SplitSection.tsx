...
export default function SplitSection({
    ...
    // In RTL:
    // First element in grid is on the Right.
    // Second element in grid is on the Left.
    // If imagePosition is 'left' (default): We want Text (Right), Image (Left).
    // So order: TextDiv, ImageDiv.
    // If imagePosition is 'right': We want Image (Right), Text (Left).
    // So order: ImageDiv, TextDiv.
